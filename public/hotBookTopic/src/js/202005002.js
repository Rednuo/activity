...
new Vue({
    ...
    mounted: function () {
        this.umeng('202005002访问')
        HybridApi.setUserBehavior(`f02##-1|202005002`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202005002视频播放');
        },
        clickDownload: function () {
            this.umeng('202005002点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
