...
new Vue({
    ...
    mounted: function () {
        this.umeng('202007010访问')
        HybridApi.setUserBehavior(`f02##-1|202007010`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202007010视频播放');
        },
        clickDownload: function () {
            this.umeng('202007010点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
