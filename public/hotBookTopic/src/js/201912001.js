...
new Vue({
    ...
    mounted: function () {
        this.umeng('201912001访问')
        HybridApi.setUserBehavior(`f02##-1|201912001`);
        this.init();
    },
    methods: {
        init(){
        ...
        umeng: function(action){
            _czc.push(["_trackEvent", "异业置换", "活动H5", action, 1, "active"]);
        },
        ...
        clickVideo:function () {
            this.umeng( '201912001视频播放' );
        },
        clickDownload:function () {
            this.umeng( '201912001点击下载' );
            location.href = 'https://s.zhuishushenqi.com/Lmbtt2.apk';
        },
        getUserInfo() {
            let self=this;
            if(self.token){
