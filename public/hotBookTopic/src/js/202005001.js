...
new Vue({
    ...
    mounted: function () {
        this.umeng('202005001访问')
        HybridApi.setUserBehavior(`f02##-1|202005001`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202005001视频播放');
        },
        clickDownload: function () {
            this.umeng('202005001点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
