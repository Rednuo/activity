...
new Vue({
    ...
    mounted: function () {
        this.umeng('202006019访问')
        HybridApi.setUserBehavior(`f02##-1|202006019`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202006019视频播放');
        },
        clickDownload: function () {
            this.umeng('202006019点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
