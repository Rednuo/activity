...
new Vue({
    ...
    mounted: function () {
        this.umeng('202006011访问')
        HybridApi.setUserBehavior(`f02##-1|202006011`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202006011视频播放');
        },
        clickDownload: function () {
            this.umeng('202006011点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
