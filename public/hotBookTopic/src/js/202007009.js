...
new Vue({
    ...
    mounted: function () {
        this.umeng('202007009访问')
        HybridApi.setUserBehavior(`f02##-1|202007009`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202007009视频播放');
        },
        clickDownload: function () {
            this.umeng('202007009点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
