...
new Vue({
    ...
    mounted: function () {
        this.umeng('201906001访问')
        HybridApi.setUserBehavior(`f02##-1|201906001`);
        this.init();
    },
    methods: {
        init(){
        ...
        getBookList() {
            let self = this;
            axios.get(`${url.getBookListNode}54c4487aaadc406cbebda582581bc9dc`).then((res) => {
                res = res.data;
                if (res && res.ok) {
                    console.log(res)
