...
new Vue({
    ...
    mounted: function () {
        this.umeng('202006018访问')
        HybridApi.setUserBehavior(`f02##-1|202006018`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202006018视频播放');
        },
        clickDownload: function () {
            this.umeng('202006018点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
