...
new Vue({
    ...
    mounted: function () {
        this.umeng('202007013访问')
        HybridApi.setUserBehavior(`f02##-1|202007013`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202007013视频播放');
        },
        clickDownload: function () {
            this.umeng('202007013点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
