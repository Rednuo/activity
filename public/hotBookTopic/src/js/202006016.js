...
new Vue({
    ...
    mounted: function () {
        this.umeng('202006016访问')
        HybridApi.setUserBehavior(`f02##-1|202006016`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202006016视频播放');
        },
        clickDownload: function () {
            this.umeng('202006016点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
