...
new Vue({
    ...
    mounted: function () {
        this.umeng('202006012访问')
        HybridApi.setUserBehavior(`f02##-1|202006012`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202006012视频播放');
        },
        clickDownload: function () {
            this.umeng('202006012点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
