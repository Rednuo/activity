...
new Vue({
    ...
    mounted: function () {
        this.umeng('202005022访问')
        HybridApi.setUserBehavior(`f02##-1|202005022`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202005022视频播放');
        },
        clickDownload: function () {
            this.umeng('202005022点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
