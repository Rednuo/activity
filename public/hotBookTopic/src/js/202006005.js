...
new Vue({
    ...
    mounted: function () {
        this.umeng('202006005访问')
        HybridApi.setUserBehavior(`f02##-1|202006005`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202006005视频播放');
        },
        clickDownload: function () {
            this.umeng('202006005点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
