...
new Vue({
    ...
    mounted: function () {
        this.umeng('202005003访问')
        HybridApi.setUserBehavior(`f02##-1|202005003`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202005003视频播放');
        },
        clickDownload: function () {
            this.umeng('202005003点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
