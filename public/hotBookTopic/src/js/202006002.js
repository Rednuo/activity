...
new Vue({
    ...
    mounted: function () {
        this.umeng('202006002访问')
        HybridApi.setUserBehavior(`f02##-1|202006002`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202006002视频播放');
        },
        clickDownload: function () {
            this.umeng('202006002点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
