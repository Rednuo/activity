...
new Vue({
    ...
    mounted: function () {
        this.umeng('202007011访问')
        HybridApi.setUserBehavior(`f02##-1|202007011`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202007011视频播放');
        },
        clickDownload: function () {
            this.umeng('202007011点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
