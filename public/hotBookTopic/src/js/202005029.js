...
new Vue({
    ...
    mounted: function () {
        this.umeng('202005029访问')
        HybridApi.setUserBehavior(`f02##-1|202005029`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202005029视频播放');
        },
        clickDownload: function () {
            this.umeng('202005029点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
