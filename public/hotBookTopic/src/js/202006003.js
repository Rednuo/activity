...
new Vue({
    ...
    mounted: function () {
        this.umeng('202006003访问')
        HybridApi.setUserBehavior(`f02##-1|202006003`);
        this.init();
    },
    methods: {
        init() {
        ...
        clickVideo: function () {
            this.umeng('202006003视频播放');
        },
        clickDownload: function () {
            this.umeng('202006003点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
