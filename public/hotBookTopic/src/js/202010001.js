...
new Vue({
    ...
    mounted: function () {
        this.umeng('202010001访问')
        HybridApi.setUserBehavior(`f02##-1|202010001`);
    ...
    methods: {
        clickBtn() {
            HybridApi.setSensorsUserBehavior({
                ...
                "btn_click_category2": "国庆活动预热",
                "btn_click_category3": "活动开始页面-书城",
                "btn_click_category4": "去开宝箱-点击",
        ...
        clickVideo: function () {
            this.umeng('202010001视频播放');
        },
        clickDownload: function () {
            this.umeng('202010001点击下载');
        },
        getUserInfo() {
            let self = this;
            if (self.token) {
