...
function gameover() {
 ...
 if(stscore>theirbest) {
  ...
  theirbest=stscore;
  ialert('<h1>游戏结束: '+stscore+'分</h1>厉害，你又破纪录了','goGame(stscore);');
 } else {
  ialert('<h1>游戏结束: '+stscore+'</h1>','goGame(stscore);');
 }
 //urchinTracker('/stack/gamesplayed/');
 return false;
}
function goGame(a) {
  location.href="http://m.manhuadao.cn/activity/pet/ppgame.html?gameid=1&&score="+a
}
