...
const vm = new Vue({
    ...
    methods: {
        ...
        Sign:function (item, isrepairsign) {
            ...
            if (isrepairsign) {
                tumeng.push(['2020双旦活动-元气','点击签到']);
            } else {
                tumeng.push(['2020双旦活动-元气','点击补签']);
            }
            return new Promise((resolve, reject) => {
                axios({
                    method: 'POST',
            ...
            return new Promise((resolve, reject) => {
                axios({
                    ...
                    if (data.data.code == 200) {
                        ...
                        self.showModal = true;
                        if(info){
                            tumeng.push(['2020双旦活动-元气','瓜分奖励弹窗']);
                        }else{
                            tumeng.push(['2020双旦活动-元气','未中奖']);
                        }
