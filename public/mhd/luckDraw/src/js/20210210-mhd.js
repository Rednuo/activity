...
const vm = new Vue({
    ...
    methods: {
        ...
        goHotBook:function () {
            ...
            HybridUtil.request({
                ...
                param: {
                    ...
                    'fullscreen': 1,
                    'title':'爆款书籍',
                    'link':'http://m.manhuadao.cn/activity/mhd-hotBookTemplate/index.html?specialid=1226'
                },
                callback:function () {
                },
            });
        ...
        goDiscount:function () {
            ...
            HybridUtil.request({
                ...
                param: {
                    ...
                    'fullscreen': 1,
                    'title':'爆款书籍',
                    'link':'http://m.manhuadao.cn/activity/mhd-hotBookTemplate/index.html?specialid=1227'
                },
                callback:function () {
                },
            });
        ...
        onClickCard(item) {
            let self = this;
            if(new Date('2021/02/21 20:00:00') > self.currentTime){
                if (!self.isSignUp) {
                    Toast.show('需要先报名活动');
                    return
                }
