...
const StatisicsService = {
    getToken: function() {
        return getFingerprint2().then(function(data) {
            ...
            let userId = localStorage.getItem('userId') || '0000',
                biTokenCache = localStorage.getItem('H5_BI_Token_'+userId),
                device_imei = data;
    ...
    post: function( param ) {
        ...
        let self = this,
            ...
            biTokenCache = localStorage.getItem('H5_BI_Token_'+userId),
            pos_name = localStorage.getItem('pos_name') || '-1';
        ...
        getFingerprint2().then((device_imei) => {
            try {
                ...
                self.getToken().then(function(data) {
                    ...
                    if (!biTokenCache) {
                        localStorage.setItem('H5_BI_Token_'+userId, data.msg);
                    }
