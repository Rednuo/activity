...
new Vue({
    ...
    data: {
       ...
       appNode: getQueryParams('node') || '725318d9a936427f81f9f1737537734f',
    ...
    methods: {
        ...
        configInfo: function(){
            ...
            ysf.config({
                ...
                data:JSON.stringify([
                    ...
                    {"index":2, "key":"userFrom","label":"用户来源","value":"快应用"},
        ...
        clickKF() {
            ...
            var path = 'http://h5.zhuishushenqi.com/public/privateDomain/leadCodeForFAQ_kyy.html' + '?userid=' + this.userId + '&fromPage=56'
            location.href = path;
        },
    },
    watch: {
