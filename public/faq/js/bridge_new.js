...
var HybridApi = {
    ...
    onWebviewLoaded: function( params ){
        this.request({
            action: 'onWebviewLoaded',
            param: JSON.stringify( params ),
            callback: function(data) {
